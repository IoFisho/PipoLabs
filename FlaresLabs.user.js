...
// Dichiaro i vari token da utilizzare in Labs	
...
*/
    ...
    function waitForLabs(mutations, observer){
        ...
        if(document.querySelectorAll(elemTrigger).length > 0 && !document.getElementById("assistContainer")) {
            ...
            profileModalContent.innerHTML = '<div class="assist-modal-header"><span>Profile Selection</span><div class="assist-modal-header-right"><span class="assist-modal-close">x</span></div></div><div class="assist-modal-body"><span id="assist-modal-error"></span><div></div><span>Select a profile to connect to FlaresLabs.</span><div></div><div id="profileDiv" max-width="100%"></div></div>';
